...
<?php include_once('header.php'); ?>
 ...
 <div class="container" style="height:600px;">
   ...
   <div class="card card-login mt-5">
     ...
     <div class="card-body">
       <form method="post" action="includes/loginAdmin" class="needs-validation" >
         <div class="form-group">
           <label for="Username">Username</label>
           <input class="form-control"  type="text" name="username" maxlength = "20" placeholder="Please enter Username....." required>

...
<div class="container">
    ...
    <div id="accordion">
            ...
            <div class="card-header mb-1" id="headingOne">
                <h5 class="mb-0">
                    <button class="btn collasped" data-toggle="collapse" data-target="#collapse<?php echo $faq['id'] ?>"
                        ...
                        <strong><span
                                style="color:#12A4D3;font-size:16px;text-decoration:none;font-weight:300;"><?php echo $faq['question'] ?></span></strong>
                    </button>
                </h5>
            </div>
        </div>
        ...
        <div id="collapse<?php echo $faq['id'] ?>" class="collapse hide " aria-labelledby="headingOne"
            ...
            <div class="card-body" style="word-wrap:break-word;font-weight:300;">
                <?php echo $faq['answer']  ?>
            </div>
        </div>
        <?php endforeach; ?>

    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <p class="mt-5 lead">
                ...
                Offering ‘first world’ patient care, Dr June Williams, the first female head of the department, and
                current Clinical Director applauds the skill set of her staff and also notes that the A&E improvement
                programme has put measures in place to make the visit to A&E a more comfortable one. Measures include
                the addition of patient advocates, a redesign of the physical space, improvements to staffing
                compliments, improved outreach and efficiencies plus a concerted, ongoing effort to reduce waiting
                times.</p>

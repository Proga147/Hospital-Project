...
<div class="container bg-white border-top rounded">
...
<div class="tab-content" id="myTabContent">
  ...
  <h3 class="mt-5"> Accident & Emergency Overview </h3><hr>
  <p class="mt-5 lead">

    The Accident and Emergency Department created in 2020 is committed to the provision of quality, timely emergency care, to acutely sick and injured persons; both citizens and visitors alike.
    Pioneered by Dr Michael Holder and Dr Vanessa Harold, has opened with a team of initially 12 doctors and 16 consultants and 8 nurses . As the busiest department in the hospital, the A&E Department attends to approximately 15,000 patients annually.
    Offering ‘first world’ patient care, Dr June Williams, the first female head of the department, and current Clinical Director applauds the skill set of her staff and also notes that the A&E improvement programme has put measures in place to make the visit to A&E a more comfortable one. Measures include the addition of patient advocates, a redesign of the physical space, improvements to staffing compliments, improved outreach and efficiencies plus a concerted, ongoing effort to reduce waiting times.</p>
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/ane.png" alt="First slide" >
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/ane2.png" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/ane3.png" alt="Third slide">
          </div>
        </div>
  ...
  <p class="lead">
        ...
        Our physicians and nurses are here to help you and your relatives during your visit to the Emergency Department.
        The following infomation is what you should know before and during a visit to the Accident & Emergency Department:
      </p>  <br><br>
          <ul>
            <li>  <p class="lead"> <strong>Be sure to always have your identification cards, list of current medications</strong> (including dosages and schedules) and if you are bringing a child, be sure to have the <strong>immunization card </strong>(Green Book)</p></li>
            <li>  <p class="lead"> Ask our staff if you have any questions or concerns about your relative’s treatment, procedures and medications.</p></li>
          </ul><hr>
      ...
      <p class="lead">  Patients will be instructed to complete a registration upon arrival. Patients will need to provide their <strong>full name, date of birth, national registration number or passport number, gender and the reason for visit</strong>.
          Patients will then be assessed by the triage nurse. If the patient’s treatment is urgent, they will be taken to the treatment area. If the patient is stable, they will finish the registration process and be taken
          to the treatment area when there is a room available. The staff of the Emergency Department is committed to providing the most accurate and efficient treatment to the patients it serves.</p>
        ...
        <p class="lead">The waiting rooms are provided for the comfort of patients and their relatives or friends. The outside waiting area is open 24 hours a day and includes television-viewing areas, and vending machines just outside the area.
          It also has a stand alone phone charging ports for your convenience. Patients can expect to wait until their tests are completed and the results are back. The Emergency Department is often very busy with many patients
          requiring immediate or urgent treatment.</p><hr>
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
    <p class="mt-5 lead">The Accident and Emergency department provides care for patients who may have an urgent need for medical, surgical or other care 24/7.</p>
    <br><br> <div class="row text-center"><div class="col-sm-6 col-xs-12 col-lg-5"><img src="images/all.png" alt="all day"></div><div class="col-sm-6 col-xs-12 col-lg-5"><img src="images/award.png" alt="awards"></div></div><br>
  <p class="lead">  The Accident and Emergency department is equipped and ready to treat a wide range of medical emergiences. The Accident and Emergency Department
    is responsible for the initial stabilization and treatment for conditions within the following areas: </p><br>
  ...
  <p class="lead mt-3" ><img src="images/error.png" alt="tips for everyone"> In cases of <strong> emergency: </strong></p>
  <button class="btn btn-danger btn-lg" type="button" id="target" data-toggle="modal" data-target="#Modal2">Click Here </button>
  </div>
  <br><br>
  <div class="col-sm-4 pb-4 mt-4 ml-2" style="border:1px dashed #E0E3E4;">
  <p class="lead mt-3" ><img src="images/question.png" alt="in need of assistance click here"> In need of <strong> assistance: </strong> </p>
  <button class="btn btn-primary btn-lg" type="button" data-toggle="modal" data-target="#exampleModal">Click Here </button>
  </div>
</div>
  <br><br>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        A nurse will be over shortly to assist you. <img src="images/nurse2.png" alt="we will be with you :)">
        </div>
  ...
  <div class="modal fade" id="Modal2" tabindex="-1" role="dialog" aria-labelledby="ModalLabel2" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
        Hang tight! we will send help immediately! <img src="images/alarm.png" alt="we will be with you :)">
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
...
be given a prescription and sent home. Either way, the hospital will inform your GP that you have been to A&E.
If your situation is more complicated, you may be seen by an A&E doctor or referred to a specialist unit. For example,
   ...
   <div class="container-fluid mt-5" style="border:1px dashed #E0E3E4;">
        ...
        <div class="col-sm-6 mx-auto pt-5 pb-5">
            <form method="post" action="includes/process">
                ...
                <input type="text" id="name" class="form-control" name="patient_name"  maxlength = "70" placeholder="Enter name" required>
                </div>

                <div class="form-group">
                <label for="patid">Patient's ID: </label>
                <input type="text" id="patid" class="form-control" name="patientid" maxlength = "70" placeholder="Enter name" required>
                </div>

                  <div class="form-group">
                  <label for="patient_name">Your Name: </label>
                  <input type="text" id="patient_name" class="form-control" name="person_name" maxlength = "70" placeholder="Enter name" required>
                  </div>
                ...
                <textarea class="form-control" id="reasonforvisit"  rows="3" name="visitreason" maxlength = "300" required></textarea>
              </div>
